  ...
  return (
    <section className={clsx(styles.heroSection, className)}>
      ...
      >
        <div
          data-anim="circle"
          className={styles.heroSection__rainbowCircleBlock}
        >
          <svg
            width="1726"
            height="1726"
          ...
          >
            <circle
              ...
              cy="863"
              r="862"
              stroke="url(#paint0_linear_1198_14537)"
              strokeWidth="2"
            ></circle>
            <path
              d="M1571 832.5C1571 1218.98 1250.28 1534 852.5 1534C454.723 1534 134 1218.98 134 832.5C134 446.022 454.723 131 852.5 131C1250.28 131 1571 446.022 1571 832.5Z"
              stroke="url(#paint1_linear_1198_14537)"
              strokeOpacity="0.6"
              strokeWidth="90"
            ></path>
            <defs>
              <linearGradient
                id="paint0_linear_1198_14537"
                x1="863"
                y1="-5.20109e-08"
                x2="863.873"
                y2="1421.46"
              ...
              >
                <stop stopColor="#EBFDB8"></stop>
                <stop offset="1" stopColor="#DBF3BD" stopOpacity="0"></stop>
              </linearGradient>
              <linearGradient
                id="paint1_linear_1198_14537"
                x1="852.5"
                y1="86"
                x2="885.265"
                y2="942.379"
        ...
        <div
          data-anim="agent1"
          className={styles.heroSection__circleAgentBlock}
        >
          ...
          <div className={styles.heroSection__circleAgentBlock__message}>
            ...
            <svg
              className={styles.heroSection__circleAgentBlock__message__part}
              width="23"
              height="37"
              viewBox="0 0 23 37"
              fill="none"
        ...
        <div data-anim="agent2" className={styles.teamSection__circleAgent2}>
          <CirclePhoto imageSrc="/images/TeamPhoto/l2.webp" size={70} />
        </div>
        ...
        <div
          data-anim="agent4"
          className={styles.heroSection__circleAgentBlock4}
        >
          <div className={styles.heroSection__circleAgentBlock4__message}>
            ...
            <svg
              className={styles.heroSection__circleAgentBlock4__message__part}
              width="23"
              height="37"
              viewBox="0 0 23 37"
              fill="none"
          ...
          <div
            className={styles.heroSection__circleAgentBlock4__circleAgent4}
          />
        </div>
      </GsapAnim>
      ...
      <div className={styles.heroSection__inner}>
        <div ref={titleRef} className={styles.heroSection__inner__title}>
          ...
          <div
            ref={subtitleRef}
            className={styles.heroSection__inner__title__subtitle}
          >
            <p>
              Welcome to{" "}
              <span
                className={
                  styles.heroSection__inner__title__subtitle__coloredText
                }
              >
                IRSplusTALENT:
              </span>{" "}
            ...
            <div
              className={styles.heroSection__inner__title__subtitle__subtitle2}
            >
