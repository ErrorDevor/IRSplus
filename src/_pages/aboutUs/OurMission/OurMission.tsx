      ...
      <div className={styles.ourMissionSection__wrapper}>
        <div className={styles.ourMissionSection__wrapper__inner}>
          ...
          >
            <div
              data-anim="left-text"
              className={styles.ourMissionSection__wrapper__inner__leftSide}
            >
              <h1>
                <CircleIcon
                  color="#E6F8AF"
                ...
                <GradientText>to Redefine</GradientText> Tax and Finance
                Services
              </h1>
              <div
                className={
                  styles.ourMissionSection__wrapper__inner__leftSide__subtitle
                }
              >
                <p>
                  Since our inception, we have remained at the forefront of
                  industry advancements, constantly adapting to the changing tax
                  landscape to provide our clients with cutting-edge solutions.
                  Our team of experts, comprising seasoned professionals with
                  extensive experience in taxation and finance, brings a wealth
                  of knowledge and expertise to every client engagement. 
                </p>
          ...
          <div className={styles.ourMissionSection__wrapper__inner__rightSide}>
            <div
              ref={labelBlockRef}
              className={
                styles.ourMissionSection__wrapper__inner__rightSide__imageBlock
              }
            >
              <GsapAnim
                animation="fade-scale"
              ...
              >
                <Image
                  data-anim="image"
                  className={
                    styles.ourMissionSection__wrapper__inner__rightSide__imageBlock__image
                  }
                  priority
                  src="/images/IRSplusIncentivesAndCredits/OurMission/ourMission.webp"
                  alt="OurMissionImage"
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                />

                <div data-anim="union" className={styles.union}>
                  <svg
                    width="125"
                    height="125"
                    viewBox="0 0 125 125"
              ...
              {labelBenefitsData.map((item, index) => (
                <div
                  key={index}
                  data-row
                  className={styles[`rightSideLabelBenefit${index + 1}`]}
                >
                  <LabelBenefit
